...
function filtrarEventos(estado, fechaIniDesde, fechaIniHasta, entidad, tActividad, actividad, modalidad, lugar, recinto, multikirola, adaptado, inclusivo, relevante) {
   var importante;
   if (relevante === "SI") {
       importante = true;
   } else {
