...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="create" action="listFiles"
                            params="['balanceId': balance.id]">Ficheros</g:link></li>
            </ul>
        </div>
        <div id="show-balance" class="content scaffold-show" role="main">
            ...
            <f:display bean="balance" />
            <g:form resource="${this.balance}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.balance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
