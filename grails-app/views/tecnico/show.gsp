...
<html>
    ...
    <body>
        ...
        <div id="show-tecnico" class="content scaffold-show" role="main">
            ...
            <f:display bean="tecnico" />
            <g:form resource="${this.tecnico}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tecnico}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
