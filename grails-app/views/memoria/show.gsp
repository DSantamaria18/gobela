...
<body>
<a href="#show-memoria" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="create" action="imprimirMemoria"
                    params="['memoriaId': memoria.id]">>Imprimir</g:link></li>
    </ul>
</div>
...
<div id="show-memoria" class="content scaffold-show" role="main">
    ...
    <g:form resource="${this.memoria}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${this.memoria}"><g:message code="default.button.edit.label"
                                                                                     default="Edit"/></g:link>
