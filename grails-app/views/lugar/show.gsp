...
<body>
<a href="#show-lugar" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <sec:ifAnyGranted roles='ROLE_ADMIN, ROLE_MANAGER, ROLE_USER'>
        <g:form resource="${this.lugar}" method="DELETE">
            <fieldset class="buttons">
                <g:link class="edit" action="edit" resource="${this.lugar}"><g:message code="default.button.edit.label"
                                                                                       default="Edit"/></g:link>
